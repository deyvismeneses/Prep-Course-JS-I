...
// const nuevoModulo1 = 21 % 5;
// console.log(nuevoModulo);
// console.log(nuevoModulo1);
...
// numeroRandom() //cada vez que se da clic o se actualiza el numero cambia aleatoriamente
// numeroRandom(1)
// numeroRandom(0)
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
const unirNomApe = nombre + ' ' + apellido;
return unirNomApe;

//  const unirNomApe = "nombre" + ' ' + "apellido";
// //  const unirNomApe = "Henry" + ' ' + "Martinez";
